...
_io = [
    ...
    ("spi_afe", 0,
      ...
      # Subsignal("cs_n", 3 ,Pins("H18"), IOStandard("LVCMOS33")),
        Subsignal("data", 0, Pins("AE25"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 1, Pins("AE26"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 2, Pins("AC22"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 3, Pins("AC23"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 4, Pins("AF24"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 5, Pins("AF25"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 6, Pins("AD25"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 7, Pins("AD26"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 8, Pins("AE23"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 9, Pins("AF23"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 10, Pins("AD23"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 11, Pins("AD24"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 12, Pins("AD21"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 13, Pins("AE21"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 14, Pins("AF19"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 15, Pins("AF20"), IOStandard("DIFF_SSTL18_II")),
    ...
    ("spi_afe", 1,
      ...
      # Subsignal("cs_n", 2 ,Pins("M15"), IOStandard("LVCMOS33")),
      # Subsignal("cs_n", 3 ,Pins("H18"), IOStandard("LVCMOS33")),
        Subsignal("data", 0, Pins("AE18"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 1, Pins("AF18"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 2, Pins("Y18"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 3, Pins("AA18"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 4, Pins("AE17"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 5, Pins("AF17"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 6, Pins("AA17"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 7, Pins("AB17"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 8, Pins("AC17"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 9, Pins("AD17"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 10, Pins("Y16"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 11, Pins("Y17"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 12, Pins("AB16"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 13, Pins("AC16"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 14, Pins("Y15"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 15, Pins("AA15"), IOStandard("DIFF_SSTL18_II")),
    ...
    ("spi_afe", 2,
      ...
      # Subsignal("cs_n", 1 ,Pins("K17"), IOStandard("LVCMOS33")),
        Subsignal("cs_n", 2 ,Pins("M15"), IOStandard("LVCMOS33")),
      # Subsignal("cs_n", 3 ,Pins("H18"), IOStandard("LVCMOS33")),
        Subsignal("data", 0, Pins("U25"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 1, Pins("U26"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 2, Pins("V26"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 3, Pins("W26"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 4, Pins("AB26"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 5, Pins("AC26"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 6, Pins("W25"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 7, Pins("Y26"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 8, Pins("Y25"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 9, Pins("AA25"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 10, Pins("V24"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 11, Pins("W24"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 12, Pins("AA24"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 13, Pins("AB25"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 14, Pins("AA22"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 15, Pins("AA23"), IOStandard("DIFF_SSTL18_II")),
    ...
    ("spi_afe", 3,
      ...
      # Subsignal("cs_n", 1 ,Pins("K17"), IOStandard("LVCMOS33")),
        Subsignal("cs_n", 2 ,Pins("M15"), IOStandard("LVCMOS33")),
      # Subsignal("cs_n", 3 ,Pins("H18"), IOStandard("LVCMOS33")),
        Subsignal("data", 0, Pins("W20"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 1, Pins("Y20"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 2, Pins("T19"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 3, Pins("U19"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 4, Pins("V19"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 5, Pins("W19"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 6, Pins("V18"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 7, Pins("W18"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 8, Pins("T14"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 9, Pins("T15"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 10, Pins("T17"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 11, Pins("T18"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 12, Pins("U15"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 13, Pins("U16"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 14, Pins("U14"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 15, Pins("V14"), IOStandard("DIFF_SSTL18_II")),
    ...
    ("spi_afe", 4,
      ...
      # Subsignal("cs_n", 2 ,Pins("M15"), IOStandard("LVCMOS33")),
      # Subsignal("cs_n", 3 ,Pins("H18"), IOStandard("LVCMOS33")),
        Subsignal("data", 0, Pins("P15"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 1, Pins("P16"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 2, Pins("N16"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 3, Pins("N17"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 4, Pins("R16"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 5, Pins("R17"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 6, Pins("P18"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 7, Pins("N18"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 8, Pins("K25"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 9, Pins("K26"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 10, Pins("M20"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 11, Pins("L20"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 12, Pins("L24"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 13, Pins("L25"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 14, Pins("M24"), IOStandard("DIFF_SSTL18_II")),
        Subsignal("data", 15, Pins("M25"), IOStandard("DIFF_SSTL18_II")),
      #  Subsignal("fclkp",Pins("W21"), IOStandard("DIFF_SSTL18_II")),
      #  Subsignal("fclkm",Pins("Y21"), IOStandard("DIFF_SSTL18_II")),
      #  Subsignal("dclkp",Pins("U21"), IOStandard("DIFF_SSTL18_II")),
      #  Subsignal("dclkm",Pins("V21"), IOStandard("DIFF_SSTL18_II")),
